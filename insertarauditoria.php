...
if (count($segments) >= 6) {
    ...
    // Llamar a la función insertarAuditoria con los valores de los parámetros
    $api->insertarAuditoria($IdAuditoria, $Sentencia, $Controller, $IdMenu, $IdUser, $CreateDate);

    echo 'Los datos de la auditoría se insertaron correctamente.';
} else {
