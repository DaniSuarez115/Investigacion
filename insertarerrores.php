...
if (count($segments) >= 5) {
    ...
    // Llamar a la función insertarErrores con los valores de los parámetros
    $api->insertarErrores($IdErrores, $Sentencia, $Controller, $CreatedAt, $IdUser);

    echo 'Los datos del error se insertaron correctamente.';
} else {
