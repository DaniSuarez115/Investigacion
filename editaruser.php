...
if (count($segments) >= 12) {
    ...
    // Llamar a la función editarUser con los valores de los parámetros
    $api->editarUser($IdUser, $ldPersonal, $NameUser, $LastName, $Email, $UserName, $Password, $IdRol, $CreatedAt, $Enabled, $UpdatedAt);

    echo 'Los datos del usuario se editaron correctamente.';
} else {
